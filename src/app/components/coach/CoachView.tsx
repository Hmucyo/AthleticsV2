...
export function CoachView({ currentPage, onNavigate }: CoachViewProps) {
        ...
        <div className="bg-card border border-border p-5">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="ml-auto flex gap-2">
              <button onClick={() => onNavigate('coach-calendar')} className="px-4 py-2 border border-border text-muted-foreground hover:text-foreground hover:border-foreground/20 transition-all cursor-pointer uppercase" style={{ fontFamily: 'var(--font-display)', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.06em' }}>
                View Calendar
              </button>
            </div>
          </div>
          ...
          {athletes.map(a => {
            ...
            return (
              <div key={a.id} className="bg-card border border-border">
                <div
                  className="flex items-center gap-4 px-5 py-4 cursor-pointer hover:bg-muted transition-all"
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-foreground uppercase" style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1rem', letterSpacing: '0.04em' }}>{a.name}</div>
                    <div className="text-muted-foreground" style={{ fontFamily: 'var(--font-mono)', fontSize: '0.62rem', letterSpacing: '0.06em' }}>Week {a.week} · Last active: {a.lastActive}</div>
                  </div>
                  <div className="text-center px-4">
                    ...
                    <div className="text-muted-foreground" style={{ fontFamily: 'var(--font-mono)', fontSize: '0.58rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Compliance</div>
                  </div>
        ...
        <div className="bg-card border border-border p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#60a5fa]/10 border border-[#60a5fa]/30 text-[#60a5fa] hover:bg-[#60a5fa]/20 transition-all cursor-pointer uppercase"
          ...
          {showAddExercise && (
            <div className="mb-4 p-4 border border-border bg-muted flex gap-3 items-end">
              <div className="flex-1">
              ...
              <button onClick={() => setShowAddExercise(false)} className="px-4 py-2 bg-[#60a5fa] text-white cursor-pointer hover:opacity-90 transition-opacity uppercase" style={{ fontFamily: 'var(--font-display)', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.06em' }}>Add</button>
            </div>
          )}
          <div className="space-y-2">
            {exercises.map((ex, idx) => (
              <div key={ex.id} className="flex items-center gap-4 py-2.5 border-b border-border last:border-0">
    ...
    return (
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
        <div className="flex items-start justify-between">
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 bg-[#60a5fa] text-white hover:opacity-90 transition-opacity cursor-pointer uppercase" style={{ fontFamily: 'var(--font-display)', fontSize: '0.82rem', fontWeight: 700, letterSpacing: '0.06em' }}>
        ...
        <div className="space-y-3">
          {sessions.map(s => (
            <div key={s.id} className="bg-card border border-border p-5 flex items-start gap-5">
              <div className="border-l-2 border-[#60a5fa] pl-4 min-w-0">
